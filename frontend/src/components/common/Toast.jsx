  ...
  warning: {
    ...
    icon: (
      <svg className="w-4 h-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0 3h.008v.008H12V15.75zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    ),
  },
};
    ...
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-[100] animate-toastSlideUp">
      <div className={`flex items-center gap-2.5 px-4 py-3 rounded-xl ${style.bg} ${style.text} ring-1 ${style.ring} shadow-lg shadow-black/10`}>
        ...
        <button
          ...
          className="ml-2 p-0.5 rounded-md hover:bg-white/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wbo-700/40"
        >
