        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              ...
              className="sm:opacity-0 sm:group-hover:opacity-100 min-w-11 min-h-11 flex items-center justify-center p-1 rounded-lg text-slate-300 dark:text-slate-600 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-150 shrink-0 mt-[-1px]"
            >
              ...
              <div className="flex items-center gap-0.5 sm:gap-1 shrink-0">
                {notifications.length > 0 && (
                  <button
                    ...
                    className="min-w-11 min-h-11 flex items-center justify-center p-2 rounded-lg text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200"
                    title="Clear inbox"
                ...
                {notifications.length > 0 && (
                  <button
                    ...
                    className="min-w-11 min-h-11 flex items-center justify-center p-2 rounded-lg text-slate-400 dark:text-slate-500 hover:text-wbo-700 dark:hover:text-wbo-400 hover:bg-wbo-50 dark:hover:bg-wbo-500/10 transition-all duration-200"
                ...
                <button
                  ...
                  className="min-w-11 min-h-11 flex items-center justify-center p-1.5 rounded-lg text-slate-300 dark:text-slate-600 hover:text-slate-500 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/[0.06] transition-all duration-200"
                  aria-label="Close"
                >
