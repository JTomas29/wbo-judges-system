      ...
      {isStaff && (
        <div className="bg-white rounded-xl shadow-sm p-5 mb-6">
          ...
          <div className="flex gap-3 flex-wrap">
            <button className="inline-flex items-center justify-center px-5 py-2.5 bg-[#6b1421] text-white rounded-lg text-sm font-semibold hover:bg-[#4a0f14] transition-colors disabled:opacity-40 disabled:cursor-not-allowed" disabled={fight.status !== 'active'} onClick={() => navigate(`/judges/assign/${fight.id}`)}>Asignar Jueces</button>
