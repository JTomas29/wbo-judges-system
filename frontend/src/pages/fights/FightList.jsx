            ...
            <tbody>
              {fights.map((fight) => (
                <tr key={fight.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-600">{fight.weight_class || 'â€”'}</td>
                  <td className="py-3 px-4 text-gray-600">{fight.venue || 'â€”'}</td>
                  <td className="py-3 px-4 text-gray-600">{fight.referee_name || 'â€”'}</td>
