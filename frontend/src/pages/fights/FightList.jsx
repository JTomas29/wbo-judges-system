...
/* ─── Boxing Glove Icon ─── */
const BoxingGloveIcon = ({ className = 'w-4 h-4' }) => (
  ...
  return (
    <div className="space-y-6 animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-wbo-700 to-wbo-800 flex items-center justify-center shrink-0 shadow-lg shadow-wbo-700/20 ring-1 ring-white/10">
              <BoxingGloveIcon className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
            </div>
