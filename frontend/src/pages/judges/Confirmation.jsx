            ...
            {isPending ? (
              ...
              <div>
                {isActive && a.scorecard_status === 'finalized' ? (
                  <div>
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-green-50 text-green-700 text-sm font-semibold mb-3">
                    ...
                    <div>
                      <button
                        className="inline-flex items-center justify-center px-5 py-2.5 border border-[#6b1421] text-[#6b1421] rounded-lg text-sm font-semibold hover:bg-[#fcf0f2] transition-colors"
